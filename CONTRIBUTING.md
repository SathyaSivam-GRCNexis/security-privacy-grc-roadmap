...
- **Translations.** Open to translations of the modules into other languages, provided the translator commits to maintaining the file alongside the English version for at least 12 months.
...
- **Certification cram material.** This is not a CISSP, CISA, or CIPP exam dump. There are better resources for that.
- **AI-generated drafts pasted in unedited.** Use AI to help you think and draft. Do not submit raw model output. I can tell, and so can readers.
...
- **No em-dashes.** Use commas, full stops, or rewrite. En-dashes are fine in numeric ranges only.
...
- **No marketing voice.** Words like "leverage", "robust", "scalable", "best-in-class", "holistic", and "in today's rapidly evolving landscape" are auto-rejected. So is "journey". So is "ecosystem".

A useful test before submitting: read your contribution aloud. If it sounds like a webinar transcript, rewrite it. If it sounds like a colleague explaining something at a desk, you are close.
...
7. **Beginner mistakes.** What people get wrong. Be specific. "People confuse a DPIA with a risk assessment" is useful. "Be careful" is not.
...
PRs that miss the checklist will be commented on, not closed. We will work it out.
...
If your contribution is substantial (a new module, a significant rewrite of a section), you will be named in the module's footer and in the changelog. Smaller contributions are acknowledged in commit history.
