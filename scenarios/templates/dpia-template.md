...
> **Template note.** A DPIA is required under GDPR Article 35 (and recommended under DPDP Act 2023, mandatory for Significant Data Fiduciaries) when processing is **likely to result in a high risk to the rights and freedoms of natural persons**. Triggers include: large-scale processing of special-category data, systematic monitoring, automated decision-making with legal effects, and use of new technologies (AI, biometrics).
>
> Fill in every section. Empty sections are themselves a finding. If a section genuinely does not apply, write "Not applicable" and explain why in one sentence.
>
...
**One-paragraph plain-English description.** What are you doing, with whose data, and why? Write this as if explaining to a non-technical board member.

---

## 2. Necessity and proportionality

**Why is this processing necessary?** State the business outcome. "Because product wants it" is not an answer.
...
**For DPDP Act 2023:** Has consent been obtained per Sec. 6, or does a "legitimate use" under Sec. 7 apply? State which: _________

**Could you achieve the same outcome with less data?** Walk through the data-minimisation analysis honestly. If yes, why are you not doing that?

**Could you achieve the same outcome with anonymised or pseudonymised data?** _________
...
**Describe the flow.** Where does the data originate, where does it travel, where does it land, and where does it leave the organisation? A diagram is preferred. Annotate boundaries (controller-to-processor, intra-group, cross-border).
...
**Was a representative of data subjects consulted?** GDPR Art. 35(9) recommends this where appropriate. If you skipped it, explain why.
...
Add scenario-specific risks. Generic templates are a finding in themselves.

---

## 7. Mitigations and safeguards

For each Medium or High residual risk above, describe the safeguard:

| Risk # | Safeguard | Owner | Implementation date | Evidence |
|---|---|---|---|---|
| | | | | |

Common safeguards: encryption at rest and in transit, access controls and audit logging, pseudonymisation, retention limits with auto-deletion, role-based access, DPA in place with vendor, training for handlers, rate-limits on bulk export, vendor SOC 2 / ISO 27001 attestation reviewed, opt-out mechanism, human-in-the-loop for automated decisions.
