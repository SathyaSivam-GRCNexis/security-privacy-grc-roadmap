...
> *Alphabetised. Plain English. Cross-referenced to the module that teaches it in depth.*
...
**Authorisation** — deciding what an authenticated user is allowed to do. Often confused with authentication. See [Module 3](../modules/03-identity-and-access.md).
...
**BCP (Business Continuity Plan)** — keeping **business processes** running through a disruption. Distinct from DR. See [Module 11.5](../modules/11-incident-response-bcp.md).
...
**Breach** — confirmed unauthorised access, modification, destruction, or disclosure of data. Triggers regulatory clocks. See [Module 11.2](../modules/11-incident-response-bcp.md) and [reference/regulator-clocks.md](regulator-clocks.md).
...
**Control owner** — the operational individual responsible for implementing and running a control. Distinct from the risk owner. See [Module 8.5](../modules/08-risk-management.md).
...
**DPIA (Data Protection Impact Assessment)** — required GDPR Art. 35 assessment for high-risk processing. Required for SDFs under DPDP. See [Module 5](../modules/05-privacy-fundamentals.md), [Module 6](../modules/06-privacy-laws.md).
...
**Evidence** — artefacts an auditor can examine to confirm a control is operating. The deliverable of a GRC analyst's daily work. See [Module 9](../modules/09-audit-lifecycle.md).

**Exception** — a documented, approved deviation from a policy or control. Distinct from non-conformity. See [Module 9](../modules/09-audit-lifecycle.md).
...
**Residual risk** — risk remaining after controls are applied. Executives care about this, not inherent risk. See [Module 0.4](../modules/00-foundation-pack.md).
...
**Risk register** — the artefact listing identified risks with scores, owners, treatments. The heart of the GRC programme. See [Module 8.4](../modules/08-risk-management.md).
...
**SoA (Statement of Applicability)** — ISO 27001 document listing all 93 Annex A controls, applicability, justification, status. The backbone of an ISO audit. See [Module 7.2](../modules/07-grc-frameworks.md).
...
> *Missing a term? Open an issue. The glossary grows with the curriculum.*
