...
|---|---|---|
| 🟢 **A non-tech beginner** exploring whether security, privacy or GRC is for you | The foundation pack and the GRC core (Modules 0, 1, 3, 5–10) | [paths/00-non-tech-beginner.md](paths/00-non-tech-beginner.md) |
...
If you are not sure which one you are, read [START-HERE.md](START-HERE.md) first. Five minutes, then you will know.
...
- A populated **risk register** (with owners, scores, treatment plans, and review dates)
...
- An **incident response runbook** for at least one playbook (ransomware, data exposure, vendor outage, take your pick)
...
This curriculum is current to April 2026 and explicitly covers:
...
If a YouTube playlist or blog post does not mention versions, it is probably out of date. This curriculum tells you the version because the version is what gets you through the interview.
...
Every required resource in this curriculum is free. Where a paid resource is genuinely worth the money (a specific certification, a specific book that has no online substitute), it is flagged with 💰 and clearly marked optional.
...
References are re-verified every quarter. The last full check was **17 April 2026** and it is dated on every reference list. If you find a stale link, an outdated regulation, or a framework that has shipped a new version, open an issue — it gets fixed.

---

## A note on ethics

You will learn things in this curriculum that can harm people if misused. Threat models, attack patterns, data extraction techniques, social engineering vectors. Do not.
